using CSDiagADSL.Tests.Shared;
using CSDiagADSL.Persistence;
using CSDiagADSL.Persistence.Models;
using CSDiagADSL.Services;
...
namespace CSCore.Tests.Services
{
    public class JobServiceTests : ApplicationDBFixture
    {
        ...
        [Fact]
        public async Task Exec_ExecutesDiagADSLProcess_DoesNotFindPendingTickets()
        {
            // Arrange
            // 
